    ...
    <View style={styles.container}>
      ...
      <View style={styles.footer}>
        ...
        <View style={styles.controlsRow}>
          <Pressable onPress={()=>setOnStart(!onStart)} style={styles.iconButtonContainer}>
            <MaterialCommunityIcons  
              name="power" 
              size={42} 
              color={onStart ? 'white' : 'gray'}
            />
          ...
          <View style={styles.temperatureContainer}>
            <Entypo onPress={()=>setTemperature(temperature -1)} name="chevron-left" size={30} color="gray" />
            <Text style={styles.temperatureText}>{temperature}°</Text>
            <Entypo onPress={()=>setTemperature(temperature + 1)} name="chevron-right" size={30} color="gray" />
          </View>
          ...
          <View style={styles.iconButtonContainer}>
            <Pressable onPress={()=>setVent(!vent)} style={styles.iconButtonContainer}>
              ...
              <Text style={styles.iconButtonText}>{vent ? 'vent' : 'unvent'}</Text>
            </Pressable>
          </View>
